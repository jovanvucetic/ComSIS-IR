export class Constants {
    ...
    public static readonly KeyWordsPropery = "Key words";
    ...
    public static readonly SearchByKeyWords = "/publications/search/keywords?query="
    ...
    public static readonly MostFrequentAuthors = "/statistics/authors";
    public static readonly MostFrequentKeyWords = "/statistics/mostFrequentKeyWords"
    public static readonly KeyWordTrend = "/statistics/getKeyWordTrend?keyWord="
